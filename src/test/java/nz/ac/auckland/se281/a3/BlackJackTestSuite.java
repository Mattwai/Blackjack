...
public class BlackJackTestSuite {
	...
	public static class YourTest extends TaskTest {
		@Test
		public void T4_01_player_dealer_bust() {
			BlackJack blackJack = new BlackJack(
					// first round
					new Card(EIGHT, CLUBS), new Card(ACE, HEARTS), new Card(NINE, CLUBS), new Card(QUEEN, HEARTS),
					new Card(NINE, HEARTS), new Card(JACK, SPADES), new Card(ACE, SPADES), new Card(TEN, CLUBS), // dealer
																													// win
					// second round
					new Card(NINE, CLUBS), new Card(ACE, HEARTS), new Card(EIGHT, CLUBS), new Card(QUEEN, HEARTS),
					new Card(EIGHT, CLUBS), new Card(NINE, HEARTS), new Card(JACK, SPADES), new Card(NINE, SPADES),
					new Card(TEN, CLUBS),
					// third round
					new Card(TEN, CLUBS), new Card(ACE, HEARTS), new Card(EIGHT, CLUBS), new Card(QUEEN, HEARTS),
					new Card(NINE, HEARTS), new Card(JACK, SPADES), new Card(KING, SPADES), new Card(TEN, CLUBS),
					new Card(FIVE, CLUBS), new Card(KING, CLUBS), // player win
					// fourth round
					new Card(KING, CLUBS), new Card(ACE, HEARTS), new Card(TEN, CLUBS), new Card(QUEEN, HEARTS),
					new Card(ACE, HEARTS), new Card(JACK, SPADES), new Card(KING, SPADES), new Card(ACE, CLUBS),
					// fifth round
					new Card(KING, CLUBS), new Card(ACE, HEARTS), new Card(SIX, HEARTS), // human wins
					new Card(TEN, CLUBS), new Card(QUEEN, HEARTS), // BOT blackjack
					new Card(ACE, HEARTS), new Card(JACK, SPADES), // BOT blackjack
					new Card(KING, SPADES), new Card(TEN, CLUBS), // dealer cannot win
					// sixth round
					new Card(KING, CLUBS), new Card(NINE, HEARTS), new Card(TEN, HEARTS), // human wins
					new Card(TEN, CLUBS), new Card(QUEEN, HEARTS), // BOT blackjack
					new Card(ACE, HEARTS), new Card(JACK, SPADES), // BOT blackjack
					new Card(KING, SPADES), new Card(TEN, CLUBS) // dealer cannot win
			...
			runCommands(blackJack, "HR", "10", "hold", " ", " ", "yes", "10", "hold", " ", " ", "yes", "10", "hold",
					" ", " ", "yes", "10", "hold", " ", " ", "yes", "30", "hit", " ", " ", "yes", "30", "hold", " ",
					" ", "yes", "30", "hit", "hold", " ", "yes", "30", "hit", "hold", " ", "no");
